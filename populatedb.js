...
async function createItems() {
  ...
  await Promise.all([
    itemCreate("Tomato", "Best Tomato", categories[2], "$5.99", 20),
    itemCreate("Bell pepper", "Best Bell pepper", categories[2], "$7.99", 30),
    itemCreate("Peach", "Best Peach", categories[2], "$10.99", 10),
    itemCreate("Pruner", "Best Pruner", categories[0], "$9.20", 20),
    itemCreate("Watering can", "Best Watering can", categories[0], "$8.79", 30),
    itemCreate("Umbrella", "Best Umbrella", categories[1], "$39.99", 10),
    itemCreate("Wind chime", "Best Wind chime", categories[1], "$7.65", 50),
  ]);
}
